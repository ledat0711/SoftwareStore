...
export default function AdminProductsClient({
  ...
  const [filters, setFilters] = useState<{ category: string[]; platform: string[] }>({
    category: [],
    platform: [],
  });
          ...
          <aside className="grid gap-4 rounded-2xl border border-gray-200 bg-white p-3">
            <form className="grid gap-2.5" onSubmit={handleCreate}>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewProd({ ...newProd, rating: parseFloat(e.target.value || "0") })
                }
              />
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                ...
                <select
                  ...
                  onChange={(e) => setNewProd({ ...newProd, platform: e.target.value })}
                >
              ...
              <label className="mt-1.5 flex items-center gap-2 text-sm text-gray-800">
                <input
                  ...
                  onChange={(e) => setNewProd({ ...newProd, hidden: e.target.checked })}
                />
                <span>Hidden</span>
              </label>
            ...
            <div className="border-t border-gray-200 pt-3">
              <h3 className="mb-1.5 text-sm font-semibold text-gray-900">Categories</h3>
            ...
            <div className="border-t border-gray-200 pt-3">
              <h3 className="mb-1.5 text-sm font-semibold text-gray-900">Available on</h3>
              {platformOptions.map((p) => (
                <label
                  key={p}
                  className="grid grid-flow-col items-center justify-start gap-2 py-1 text-sm text-gray-800"
                    ...
                    <div className="grid gap-1.5">
                      ...
                      {p.badge && (
                        <small className="text-[11px] text-gray-900">
                          Badge: <span className="font-semibold text-blue-600">{p.badge}</span>
                        </small>
                      )}
                      <small className="text-[11px] text-gray-500">slug: {p.slug}</small>
                      <small className="text-[11px] text-gray-500">
                        Category: {p.category}
                        <br />
                        Platform: {p.platform}
                      </small>
                      {p.hidden && <small className="text-xs text-gray-400">Hidden</small>}
                    </div>
